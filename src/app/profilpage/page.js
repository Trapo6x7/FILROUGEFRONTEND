...
export default function Profil() {
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              className="mt-1 block w-[200%] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#9ba2ff] focus:border-[#9ba2ff]"
            />
          </div>
        </div>
  ...
  return (
    <main className="text-secondary-gray bg-[#ffe47b] text-[#333333] ">
      <section className="flex p-10 divide-x justify-center items-center">
        <section className="flex flex-col gap-8 w-1/6 justify-center items-center">
          <div className="flex flex-col gap-1 items-center justify-start">
            <img
              ...
              className="w-1/3"
            />
            <h2 className="font-bold text-md">{user.pseudo}</h2>
        ...
        <section className="flex flex-col gap-8 w-5/6 p-5 justify-center items-center">
