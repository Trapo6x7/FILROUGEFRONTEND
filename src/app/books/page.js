...
const mockBooks = [
  ...
  },
  {
    ...
    description:
      "Dans une société totalitaire, un homme se rebelle contre le système qui l'oppresse.",
    price: 19.99,
    stock: 0,
    coverImage:
      "https://www.gallimard.fr/system/files/migrations/ouvrages/couvertures/G00686.jpg",
    categories: [
  ...
  },
  {
    ...
    description:
      "Un pilote d'avion, échoué dans le désert du Sahara, rencontre un petit prince venu d'une autre planète.",
    price: 14.99,
    stock: 20,
